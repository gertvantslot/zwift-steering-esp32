...
uint16_t angle_min = 1800; // Value of potmeter, when minimum angle = -40°

// Set to the raw value measured when steering to max right
uint16_t angle_max = 2400; // Value of potmeter, when maximum angle =  40°

const uint16_t angle_error = 10; // If beneath, something is wrong with the measurements
